...
# This is a class that handles bluetooth communication with a EV3 brick.
# The bluetooth.ev3 file in the Ev3 folder is an example file that can be used to test the communication.
class Bluetooth:
